...
@Component
public class ImportantAccountToImportantAccountDtoConverter implements Converter<ImportantAccount, ImportantAccountDto> {

    public ImportantAccountDto convert(ImportantAccount importantAccount) {
